...
const Login = ()=>{
    ...
    <form className="h-auto w-96 shadow hover:shadow-lg   flex   p-3 gap-3 flex-col align-items-center" onSubmit={handleSubmit} >
        ...
        <div>
            <button type="submit" className="brand text-white h-12 w-full border border-solid border-slate-300 rounded pl-2">Login</button>
        </div>
        ...
        <hr />
        <div>
            <h3>New to Zomato ? <a href="/register" className="font">Create Account</a></h3>
        </div>
    </form>
    </div>
    )
